...
export type StatKey = 'damage' | 'burn' | 'poison' | 'shield' | 'heal' | 'regen';
...
// Icon paths + colors mirror howbazaar's in-game stat icons. Regen reuses the
// heal cross, but drawn as an outline to distinguish it from flat Heal.
